...
def weather(city: str) -> str:
    """Simulated weather forecast for a given city."""
    conditions = {
    ...
    # Look up the weather condition for the city
    info = conditions.get(city_lower, "not available right now")
...
while True:
    ...
    if user_input.lower().startswith("weather"):
        try:
            ...
            print("Agent: Could not provide weather information:", e)
            continue
